/*The function returns true if the given string is a palindrome. Otherwise, return false.
...
function palindrome(str) {
    const strRegex = /[\W_]/g;
    const reversedArr = str.replace(strRegex, "").split("").reverse();
    const reversedStr = reversedArr.join("").toLowerCase();
    if(strRegex.test(str)) {
        str = str.replace(strRegex, "").toLowerCase();
    }
